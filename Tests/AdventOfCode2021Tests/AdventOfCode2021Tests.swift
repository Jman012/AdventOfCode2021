...
final class Day20Tests: XCTestCase {
	...
	func testPart1Example() throws {
		XCTAssertEqual(day.solvePart1(input: input.inputExample1), "35")
	}
	func testPart1Real() throws {
//		print(day.solvePart1(input: input.inputMain1))
		measure(metrics: metrics, block: {
			XCTAssertEqual(day.solvePart1(input: input.inputMain1), "5179")
		})
	}
	func testPart2Example() throws {
		XCTAssertEqual(day.solvePart2(input: input.inputExample2), "3351")
	}
	func testPart2Real() throws {
//		print(day.solvePart2(input: input.inputMain2))
		measure(metrics: metrics, block: {
			XCTAssertEqual(day.solvePart2(input: input.inputMain2), "16112")
		})
	}
}
...
final class Day21Tests: XCTestCase {
	...
	var input: Input { Inputs.Day21() }
	func testPart1Example() throws {
		XCTAssertEqual(day.solvePart1(input: input.inputExample1), "739785")
	}
	func testPart1Real() throws {
//		print(day.solvePart1(input: input.inputMain1))
		measure(metrics: metrics, block: {
			XCTAssertEqual(day.solvePart1(input: input.inputMain1), "1006866")
		})
	}
	func testPart2Example() throws {
		XCTAssertEqual(day.solvePart2(input: input.inputExample2), "444356092776315")
	}
	func testPart2Real() throws {
//		print(day.solvePart2(input: input.inputMain2))
		XCTAssertEqual(day.solvePart2(input: input.inputMain2), "273042027784929")
//		measure(metrics: metrics, block: {
//			XCTAssertEqual(day.solvePart2(input: input.inputMain2), "273042027784929")
//		})
	}
...
final class Day22Tests: XCTestCase {
	...
	var input: Input { Inputs.Day22() }
	func testPart1Example() throws {
		XCTAssertEqual(day.solvePart1(input: input.inputExample1), "590784")
	}
	func testPart1Real() throws {
		print(day.solvePart1(input: input.inputMain1))
//		measure(metrics: metrics, block: {
...
//		})
	...
	func testPart2Example() throws {
//		XCTAssertEqual(day.solvePart1(input: input.inputExample2), "474140")
		XCTAssertEqual(day.solvePart2(input: input.inputExample2), "2758514936282235")
	}
	func testPart2Real() throws {
		print(day.solvePart2(input: input.inputMain2))
//		measure(metrics: metrics, block: {
...
final class Day25Tests: XCTestCase {
	...
	var input: Input { Inputs.Day25() }
	func testPart1Example() throws {
		XCTAssertEqual(day.solvePart1(input: input.inputExample1), "58")
	}
	func testPart1Real() throws {
		print(day.solvePart1(input: input.inputMain1))
//		measure(metrics: metrics, block: {
//			XCTAssertEqual(day.solvePart1(input: input.inputMain1), "557")
//		})
	}
	func testPart2Example() throws {
		XCTAssertEqual(day.solvePart2(input: input.inputExample2), "")
